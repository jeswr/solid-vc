...
const RUNTIME_SURFACE: ReadonlyArray<readonly [string, string]> = [
  ["BitstringDecodeError", "function"],
  ["CredentialNode", "function"],
  ["DEFAULT_MAX_DECODED_BYTES", "number"],
  ["DataIntegritySuite", "function"],
  ["PresentationNode", "function"],
  ["ProofNode", "function"],
  ["SEC_ASSERTION_METHOD", "string"],
  ["SEC_CONTROLLER", "string"],
  ["SEC_DIGEST_MULTIBASE", "string"],
  ["SEC_MULTIKEY", "string"],
  ["MIN_STATUS_LIST_LENGTH", "number"],
  ["SEC_PUBLIC_KEY_MULTIBASE", "string"],
  ["STATUS", "string"],
  ["STATUS_BITSTRING_CREDENTIAL", "string"],
  ["STATUS_BITSTRING_ENTRY", "string"],
  ["STATUS_BITSTRING_LIST", "string"],
  ["STATUS_ENCODED_LIST", "string"],
  ...
  ["VC", "string"],
  ["VC_CREDENTIAL_STATUS", "string"],
  ["VC_RELATED_RESOURCE", "string"],
  ["VC_V2_CONTEXT", "string"],
  ["VcDataset", "function"],
  ["agentAuthorizationFromRdf", "function"],
  ["base58btcDecode", "function"],
  ["base58btcEncode", "function"],
  ["bitstringStatusListEntry", "function"],
  ["buildAgentAuthorizationCredential", "function"],
  ["buildBitstringStatusListCredential", "function"],
  ["buildBoundAgentAuthorizationCredential", "function"],
  ["canonicalNQuads", "function"],
  ["countersign", "function"],
  ["createBitstringStatusResolver", "function"],
  ["createStatusBitstring", "function"],
  ["createWebIdKeyResolver", "function"],
  ["credentialFromRdf", "function"],
  ["credentialMetaFromNode", "function"],
  ["credentialStatusFromNode", "function"],
  ["credentialStatusesOf", "function"],
  ...
  ["decodeMultikey", "function"],
  ["decodeStatusList", "function"],
  ["defaultSuiteRegistry", "function"],
  ["digestQuads", "function"],
  ["digestRdfContent", "function"],
  ["encodeMultikey", "function"],
  ["encodeStatusList", "function"],
  ...
  ["parseAndValidateCredential", "function"],
  ["parseCredentialRdf", "function"],
  ["proofOptionsQuads", "function"],
  ["publishVerificationMethod", "function"],
  ["readStatusBit", "function"],
  ["readValidCredential", "function"],
  ["relatedResourcesFromNode", "function"],
  ["resolveBitstringStatus", "function"],
  ["resolveWebIdKey", "function"],
  ["serialize", "function"],
  ["setStatusBit", "function"],
  ["statusListBitsOf", "function"],
  ["verifyCredential", "function"],
  ["verifyRelatedResources", "function"],
  ["withStatusBit", "function"],
  ["wrapVc", "function"],
];
...
const TYPE_NAMES: readonly string[] = [
  "AgentAuthorization",
  "BitstringStatusListCredentialInput",
  "BitstringStatusListEntry",
  "BitstringStatusListEntryInput",
  "BitstringStatusOptions",
  "CountersignOptions",
  "Credential",
  ...
  "ProofSuite",
  "ProofVerifyOptions",
  "PublishVerificationMethodInput",
  "PublishedVerificationMethod",
  "RelatedResource",
  "ResolveWebIdKeyOptions",
  "ResolvedWebIdKey",
  "SuiteKeyType",
  "ValidCredentialResult",
